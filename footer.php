<div id="contact" class="container-fluid" style="background-color:#474E5D;color:white">
  <h3 class="text-left">Contract</h3>
  <p class="text-left"><em>Helpdesk.com</em></p>
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p><span class="glyphicon glyphicon-envelope"></span>Email: helpdesk@gmail.com</p>
    </div>
	<div class="container-fluid text-right">
    <div class="col-md-8">
     <p style="font-size:15px;"> &copy<strong>2018@helpdesk.com</strong></p>
    </div>
  </div>
  </div>
  </div>